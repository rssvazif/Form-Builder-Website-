...
const Heading_data= Form_store.fields.find(item => item.type === 'Heading_main')
    ...
    <div class="left-panel" :class="{show_leftPanel: props.modelValue}">
        ...
        <div class="General" v-if="tuggle_setting === 'عمومی'">
            <div class="line">
                ...
                <div class="simple-div-setting">
                    <input type="text" name="heading-text" v-model="Heading_data.Header">
                </div>
            </div>
            <div class="line">
                <div class="simple-div-setting">
                ...
                <div class="simple-div-setting">
                    <input type="text" name="subheading" v-model="Heading_data.subHeader">
                </div>
            ...
            <div class="line">
                ...
                <div class="simple-div-setting" style="display: flex; align-items: center;">
                    <span class="span-in-setting" @click="Heading_data.size = 'default'" :style="{backgroundColor:Heading_data.size === 'default'? '#0075e3':''}">پیش فرض </span>
                    <span class="span-in-setting" @click="Heading_data.size = 'big'" :style="{backgroundColor:Heading_data.size === 'big'? '#0075e3':''}">بزرگ </span>
                    <span class="span-in-setting" @click="Heading_data.size = 'small'" :style="{backgroundColor:Heading_data.size === 'small'? '#0075e3':''}">کوچک </span>
                </div>
            </div>
            <div class="line">
                <div class="simple-div-setting">
                ...
                <div class="simple-div-setting" style="display: flex; align-items: center;">
                    <span class="span-in-setting" @click.prevent="Heading_data.aligment = 'right'" :style="{backgroundColor:Heading_data.aligment === 'right'? '#0075e3':''}">راست </span>
                    <span class="span-in-setting" @click.prevent="Heading_data.aligment = 'center'" :style="{backgroundColor:Heading_data.aligment === 'center'? '#0075e3':''}">وسط </span>
                    <span class="span-in-setting" @click.prevent="Heading_data.aligment = 'left'" :style="{backgroundColor:Heading_data.aligment === 'left'? '#0075e3':''}">چپ </span>
                </div> 
