...
const Email_data = Form_store.fields.find(item => item.type === 'Email')
    ...
    <div class="left-panel" :class="{show_leftPanel: props.modelValue}">
        ...
        <div class="General" v-if="tuggle_setting === 'عمومی'">
            <div class="line">
                ...
                <div class="simple-div-setting">
                    <input type="text" name="heading-text" v-model="Email_data.value.subLabels">
                </div>
            </div>
            <div class="line">
                <div class="simple-div-setting">
                ...
                <div class="simple-div-setting" style="display: flex; align-items: center;">
                    <span class="span-in-setting" @click="Email_data.value.labelAlignment = 'right'" :style="{backgroundColor:Email_data.value.labelAlignment === 'right'? '#0075e3':''}">راست </span>
                    <span class="span-in-setting" @click="Email_data.value.labelAlignment = 'top'" :style="{backgroundColor:Email_data.value.labelAlignment === 'top'? '#0075e3':''}">بالا </span>
                    <span class="span-in-setting" @click="Email_data.value.labelAlignment = 'left'" :style="{backgroundColor:Email_data.value.labelAlignment === 'left'? '#0075e3':''}">چپ </span>
                </div>
            ...
            <div class="line">
                ...
                <div class="simple-div-setting margin-div-setting">
                    <button @click="Form_store.addFields(Email_data,Form_store.fields.length)" style="display: flex; align-items: center;justify-content: space-between;
        ...
        <div class="advanced" v-else>
            <div class="line">
                ...
                <div class="simple-div-setting">
                    <input type="text" name="subheading" v-model="Email_data.value.Email">
                </div>
                <p class="p-in-setting">افزودن یک نمونه ایمیل</p>
            </div>
        </div>
...
<style setup>
    ...
    .input-box span .subLabels{
        padding: 0;
        margin: 0;
    }
    .input-box span .subLabels input{
        border: none;
        padding: 0;
        color: #57647e;
    }
